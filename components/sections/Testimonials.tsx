...
const testimonials = [
  {
    ...
    rating: 5,
    logo: '/logos/techstart.svg' // Potential issue if asset not in public/logos
  },
  {
    id: 2,
    name: 'Michael Chen',
    ...
    rating: 5,
    logo: '/logos/innovatex.svg' // Potential issue
  },
  {
    id: 3,
    ...
    rating: 5,
    logo: '/logos/growthlabs.svg' // Potential issue
  }
];

// Mock data for client logos
const clientLogos = [
  { id: 1, name: 'TechStart', logo: '/logos/techstart.svg' }, // Potential issue
  { id: 2, name: 'InnovateX', logo: '/logos/innovatex.svg' }, // Potential issue
  { id: 3, name: 'GrowthLabs', logo: '/logos/growthlabs.svg' }, // Potential issue
  { id: 4, name: 'DataFlow', logo: '/logos/dataflow.svg' }, // Potential issue
  { id: 5, name: 'CloudNine', logo: '/logos/cloudnine.svg' }, // Potential issue
  { id: 6, name: 'FutureTech', logo: '/logos/futuretech.svg' } // Potential issue
];
